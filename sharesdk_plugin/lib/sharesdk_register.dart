...
class ShareSDKRegister {
  ...
  void setupXHS(String appId, String appUniversalLink) {
    Map info = {_ssdkAppId: appId, _ssdkAppUniversalLink: appUniversalLink};
    platformsInfo[ShareSDKPlatforms.xhs.id] = info;
  }
  ...
  void setupFlick(String apikey, String apiSecret) {
    Map info = {_ssdkApikey: apikey, _ssdkApiSecret: apiSecret};
  ...
  void setupVKontakte(String applicationId, String secretKey) {
    Map info = {_ssdkApplicationId: applicationId, _ssdkSecretKey: secretKey};
