#import "SharesdkFlutterPlugin.h"
...
@interface SharesdkFlutterPlugin()
@property (strong, nonatomic) NSDictionary *methodMap;
@end

@implementation SharesdkFlutterPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar
{
    ...
    SharesdkFlutterPlugin* instance = [[SharesdkFlutterPlugin alloc] init];
    instance.methodMap = @{
